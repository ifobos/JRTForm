...
@property (nonatomic, strong) JRTTextFieldTableViewCell     *textField;
@property (nonatomic, strong) JRTTextFieldTableViewCell     *secureTextField;
@property (nonatomic, strong) JRTTextViewTableViewCell      *textViewField;
@property (nonatomic, strong) JRTSelectTableViewCell        *selectOptionField;
@property (nonatomic, strong) JRTSelectTableViewCell        *selectMultipleOptionField;
@property (nonatomic, strong) JRTSwitchTableViewCell        *switchField;
@property (nonatomic, strong) JRTMapTableViewCell           *mapField;
@property (nonatomic, strong) JRTSubmitButtonTableViewCell  *submitButton;

@property (nonatomic, strong)JRTStringValidations * stringValidationHelper;
@property (nonatomic, strong)JRTArrayValidations  * arrayValidationHelper;
...
-(JRTStringValidations *)stringValidationHelper
{
    if (!_stringValidationHelper) _stringValidationHelper = [JRTStringValidations new];
    return _stringValidationHelper;
}

-(JRTArrayValidations *)arrayValidationHelper
{
    if (!_arrayValidationHelper) _arrayValidationHelper = [JRTArrayValidations new];
...
-(JRTTextFieldTableViewCell *)textField
{
    if (!_textField)
    {
        [self.tableView registerNib:[UINib nibWithNibName:JRTFormFieldTextFieldTableViewCell bundle:nil] forCellReuseIdentifier:ktextField];
...
-(JRTTextFieldTableViewCell *)secureTextField
{
    if (!_secureTextField)
    {
        [self.tableView registerNib:[UINib nibWithNibName:JRTFormFieldTextFieldTableViewCell bundle:nil] forCellReuseIdentifier:ksecureTextField];
...
-(JRTTextViewTableViewCell *)textViewField
{
    if (!_textViewField)
    {
        [self.tableView registerNib:[UINib nibWithNibName:JRTFormFieldTextViewTableViewCell bundle:nil] forCellReuseIdentifier:ktextViewField];
...
-(JRTSelectTableViewCell *)selectOptionField
{
    if (!_selectOptionField)
    {
        [self.tableView registerNib:[UINib nibWithNibName:JRTFormFieldSelectTableViewCell bundle:nil] forCellReuseIdentifier:kselectOptionField];
...
-(JRTSelectTableViewCell *)selectMultipleOptionField
{
    if (!_selectMultipleOptionField)
    {
        [self.tableView registerNib:[UINib nibWithNibName:JRTFormFieldSelectTableViewCell bundle:nil] forCellReuseIdentifier:kselectMultipleOptionField];
...
-(JRTSwitchTableViewCell *)switchField
{
    if (!_switchField)
    {
        [self.tableView registerNib:[UINib nibWithNibName:JRTFormFieldSwitchTableViewCell bundle:nil] forCellReuseIdentifier:kswitchField];
...
-(JRTMapTableViewCell *)mapField
{
    if (!_mapField)
    {
        [self.tableView registerNib:[UINib nibWithNibName:JRTFormFieldMapTableViewCell bundle:nil] forCellReuseIdentifier:kmapField];
...
- (JRTSubmitButtonTableViewCell *)submitButton
{
    if (!_submitButton)
    {
        static NSString *kSubmit = @"Submit";
        [self.tableView registerNib:[UINib nibWithNibName:JRTFormFieldSubmitButtonTableViewCell bundle:nil] forCellReuseIdentifier:kSubmit];
